...
def command_line_usage_examples():
    ...
    print("1. Enable pipeline checkpointing in SYNC mode (NEW!):")
    print("   python pretrain_gpt.py \\")
    print("     --use-pipeline-ckpt-worker \\")
    print("     [other training arguments...]")
    print("   # Benefits: Pipeline GPU->CPU transfer + disk write overlap")
    print("   # Behavior: Waits for each checkpoint to complete before next train step")
    
    print("\n2. Enable pipeline checkpointing in ASYNC mode:")
    print("   python pretrain_gpt.py \\")
    print("     --async-save \\")
    print("     --use-pipeline-ckpt-worker \\")
    print("     [other training arguments...]")
    print("   # Benefits: Pipeline + async execution (fastest)")
    print("   # Behavior: Checkpointing happens in background")
    
    print("\n3. Custom worker count for pipeline mode:")
    print("   python pretrain_gpt.py \\")
    print("     --use-pipeline-ckpt-worker \\")
    ...
    print("\n4. Traditional persistent async checkpointing:")
    print("   python pretrain_gpt.py \\")
    print("     --async-save \\")
    print("     --use-persistent-ckpt-worker \\")
    print("     [other training arguments...]")
    
    print("\n5. Default temporal checkpointing:")
    print("   python pretrain_gpt.py \\")
    print("     --async-save \\")
    print("     [other training arguments...]")
