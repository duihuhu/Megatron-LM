// CheckCode native module (source renamed from eclatin_native.cpp).
// PYBIND11_MODULE is checkcode_native; C++ class ECLATINNative and ECLATIN_* env
// vars are unchanged for binary/API compatibility with existing checkpoints.
...
PYBIND11_MODULE(checkcode_native, m) {
    m.doc() = "CheckCode native C++ module for erasure coding with ASIO or RDMA";
