#!/usr/bin/env python3
"""
Build script for CheckCode native module (renamed from setup_simple_eclatin.py).

Compiles checkcode_native.cpp; C++ symbols inside still use ECLATIN* names.
"""
