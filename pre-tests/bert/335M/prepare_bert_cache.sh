...
DATA_PATH="/root/Megatron-LM/pre-tests/bert/bert_data/wiki_text_sentence"
...
PYTHONPATH=$PYTHONPATH:/workspace/Megatron-LM python /workspace/Megatron-LM/pretrain_bert.py \
