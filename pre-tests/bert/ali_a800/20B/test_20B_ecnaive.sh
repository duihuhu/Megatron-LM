...
# Usage: ./test_20B_ecnaive.sh <node_rank> <gpu_id_0> [gpu_id_1 ...] [mode] [additional_args...]
#
...
#
# Example: ./test_20B_ecnaive.sh 0 0
# Example (2 GPUs per container): ./test_20B_ecnaive.sh 0 2 3 software
# Example (8 GPUs, hardware recovery): ./test_20B_ecnaive.sh 0 0 1 2 3 4 5 6 7 hardware
...
CHECKPOINT_PATH="/dev/shm/models/bert-20b-0-ecnaive"
