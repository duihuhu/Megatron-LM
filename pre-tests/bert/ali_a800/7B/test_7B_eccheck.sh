...
# Usage: ./test_7B_eccheck.sh <node_rank> <gpu_id_0> [gpu_id_1 ...] [mode] [additional_args...]
#
...
#
# Example: ./test_7B_eccheck.sh 0 0
# Example (2 GPUs per container): ./test_7B_eccheck.sh 0 2 3 software
# Example (8 GPUs, hardware recovery): ./test_7B_eccheck.sh 0 0 1 2 3 4 5 6 7 hardware
