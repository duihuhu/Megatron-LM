...
export DEBUG_COMMUNICATE=${DEBUG_COMMUNICATE:-0}
export DEBUG_PARALLEL_STATES=${DEBUG_PARALLEL_STATES:-0}
...
export MEGATRON_ECCHECK_LOAD_NET_TRACE=${MEGATRON_ECCHECK_LOAD_NET_TRACE:-0}
