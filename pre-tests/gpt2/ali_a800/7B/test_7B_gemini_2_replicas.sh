...
#
# 用法:
#   ./test_7B_gemini_2_replicas.sh <node_rank> <gpu_id_0> [gpu_id_1 ...] [mode] [additional_args...]
#
...
#   ./test_7B_gemini_2_replicas.sh 0 0
#
#   # 4 节点各 8 GPU (id 0-7)，software failure recovery
#   ./test_7B_gemini_2_replicas.sh 0 0 1 2 3 4 5 6 7 software
#
#   # 4 节点各 2 GPU (id 2,3)，hardware failure recovery，额外传入训练参数
#   ./test_7B_gemini_2_replicas.sh 0 2 3 hardware --train-iters 50
# =============================================================================
