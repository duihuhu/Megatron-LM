...
# Usage: ./test_335M_eccheck.sh <node_rank> <gpu_id_0> [gpu_id_1 ...] [additional_args...]
# Example: ./test_335M_eccheck.sh 0 0
# Example (2 GPUs per container): ./test_335M_eccheck.sh 0 2 3
...
if [ "${#GPU_IDS[@]}" -eq 0 ]; then
    ...
    echo "Usage: ./test_335M_eccheck.sh <node_rank> <gpu_id_0> [gpu_id_1 ...] [additional_args...]"
    exit 1
fi
