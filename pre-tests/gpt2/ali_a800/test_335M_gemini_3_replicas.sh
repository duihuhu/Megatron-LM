...
#
# 用法:
#   ./test_335M_gemini_replicas_legacy.sh <node_rank> <gpu_id_0> [gpu_id_1 ...] [additional_args...]
#
# 示例:
#   # 4 节点各 1 GPU (id 0)
#   ./test_335M_gemini_replicas_legacy.sh 0 0
#
#   # 4 节点各 8 GPU (id 0-7)
#   ./test_335M_gemini_replicas_legacy.sh 0 0 1 2 3 4 5 6 7
#
#   # 4 节点各 2 GPU (id 2,3)，额外传入训练参数
#   ./test_335M_gemini_replicas_legacy.sh 0 2 3 --train-iters 50
# =============================================================================
