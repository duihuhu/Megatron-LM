...
# ============================================================================
# EC-CHECK 4 Rank Test Script
# ============================================================================
# This script tests EC-CHECK with 4 ranks (can be 2 nodes × 2 GPUs or 1 node × 4 GPUs)
#   - 4 ranks total
...
# ============================================================================
# Option 1: Single node with 4 GPUs
GPUS_PER_NODE=4
NNODES=1
NODE_RANK=0

# Option 2: Two nodes with 2 GPUs each (uncomment to use)
# GPUS_PER_NODE=2
# NNODES=2
...
echo "============================================================================"
echo "EC-CHECK 4 Rank Test Configuration"
echo "============================================================================"
