...
# Usage: ./test_basic_ec.sh <node_rank> <gpu_id_0> [gpu_id_1 ...] [mode] [additional_args...]
#
...
#
# Example: ./test_basic_ec.sh 0 0
# Example (2 GPUs per container): ./test_basic_ec.sh 0 2 3 software
# Example (8 GPUs, hardware recovery): ./test_basic_ec.sh 0 0 1 2 3 4 5 6 7 hardware
...
configure_rdma_local_rank_bindings BASIC_EC
...
TENSORBOARD_LOGS_PATH=${TENSORBOARD_LOGS_PATH:-"/workspace/Megatron-LM/logs/gpt2-2.7b-4nodes/basic_ec"}
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/dev/shm/models/gpt2-2.7b-4nodes-basic-ec"}
...
export BASIC_EC_RS_CPU_LIST="$ec_cpus"
