...
# Usage: ./test_eccheck.sh <node_rank> <gpu_id_0> [gpu_id_1 ...] [mode] [additional_args...]
#
...
#
# Example: ./test_eccheck.sh 0 0
# Example (2 GPUs per container): ./test_eccheck.sh 0 2 3 software
# Example (8 GPUs, hardware recovery): ./test_eccheck.sh 0 0 1 2 3 4 5 6 7 hardware
...
configure_rdma_local_rank_bindings ECCHECK
...
TENSORBOARD_LOGS_PATH=${TENSORBOARD_LOGS_PATH:-"/workspace/Megatron-LM/logs/gpt2-20b-4nodes/eccheck"}
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/dev/shm/models/gpt2-20b-4nodes-eccheck"}
...
export ECCHECK_ENCODE_CPU_LIST="$cpu_list"
export ECCHECK_XOR_CPU_LIST="$cpu_list"
