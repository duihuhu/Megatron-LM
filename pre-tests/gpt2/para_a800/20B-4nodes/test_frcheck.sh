...
export FRCHECK_LAYER_EXCHANGE_SEG=12
export FRCHECK_LAYER_ENCODE_BATCH=12
export CUDA_DEVICE_MAX_CONNECTIONS=1
...
TENSORBOARD_LOGS_PATH=${TENSORBOARD_LOGS_PATH:-"/workspace/Megatron-LM/logs/gpt2-20b-4nodes/frcheck"}
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/dev/shm/models/gpt2-20b-4nodes-frcheck"}
...
export FRCHECK_RS_CPU_LIST="$cpu_list"
