...
# Script to run a single node in 1-node simulation (1 GPU per node)
# Usage: ./test_eccheck_1nodes_node.sh <node_rank> [additional_args...]
# Example: ./test_eccheck_1nodes_node.sh 0
