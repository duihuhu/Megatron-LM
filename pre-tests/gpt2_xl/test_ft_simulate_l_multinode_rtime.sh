...
TENSORBOARD_LOGS_PATH="/workspace/models/gpt2-l-ft-simnode/logs"
CHECKPOINT_PATH="/dev/shm/gpt2-l-ft-simnode"
DATA_PATH="/workspace/models/gpt2-l-0/codeparrot_content_document"
