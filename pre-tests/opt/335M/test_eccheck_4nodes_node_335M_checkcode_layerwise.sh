...
VOCAB_FILE="/root/Megatron-LM/pre-tests/opt/opt_data/gpt2-vocab.json"
MERGE_FILE="/root/Megatron-LM/pre-tests/opt/opt_data/gpt2-merges.txt"

TENSORBOARD_LOGS_PATH="/root/Megatron-LM/pre-tests/opt/335M/opt-335m-0/logs" #<Specify path>
CHECKPOINT_PATH="/dev/shm/models/opt-335m-0-checkcode-layerwise" #<Specify path>

# DATA_PATH="/root/Megatron-LM/pre-tests/opt/opt_data/wiki_text_sentence" #<Specify path and file prefix>_text_document
