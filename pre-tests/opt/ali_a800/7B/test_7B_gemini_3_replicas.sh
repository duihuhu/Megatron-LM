...
#
# Usage:
#   ./test_7B_gemini_3_replicas.sh <node_rank> <gpu_id_0> [gpu_id_1 ...] [mode] [additional_args...]
#
...
#
# Example:
#   ./test_7B_gemini_3_replicas.sh 0 0
#   ./test_7B_gemini_3_replicas.sh 0 0 1 2 3 4 5 6 7 software
#   ./test_7B_gemini_3_replicas.sh 0 2 3 hardware --train-iters 50
# =============================================================================
