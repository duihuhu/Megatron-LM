...
# 路径配置
# =============================BERT-L-336M================================================
VOCAB_FILE="/workspace/Megatron-LM/pre-tests/t5/data/vocab.txt"
# MERGE_FILE="/workspace/Megatron-LM/pre-tests/t52/data/t52-merges.txt"

TENSORBOARD_LOGS_PATH="/workspace/models/t5-336M-ft-simnode/logs"
CHECKPOINT_PATH="/dev/shm/t5-336M-ft-simnode"
...
FT_LAUNCHER_ARGS=(
    ...
    --rdzv_id=megatron_t5_simulated_multinode  # 作业唯一ID
